				...
				>
					<div className="container content">
						...
						>
							...
							<a
								className={`mt-4 btn ${
									index !== data.length - 1 ? 'hidden' : null
								}`}
...
const data = [
	{
		img: 'https://static.wixstatic.com/media/11062b_4b7c9a8e48334d5aad2fd274fddba3bc~mv2.jpg/v1/fill/w_1268,h_560,al_c,q_85,usm_0.66_1.00_0.01/11062b_4b7c9a8e48334d5aad2fd274fddba3bc~mv2.webp',
		title: 'Who are we',
		description:
